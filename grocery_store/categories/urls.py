...
from grocery_store.categories.views import category_add, category_details, category_edit, category_delete

urlpatterns = (
    path('add/', category_add, name="category add"),
    path('', views.category_details, name="category details"),
