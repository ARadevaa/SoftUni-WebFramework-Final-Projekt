...
SECRET_KEY = 'django-insecure-w=883%6h79l@k$p9)x9yf$wa-tgh_up$5os_7bv&6g0_0(745d'
...
INSTALLED_APPS = [
    ...
    'grocery_store.address',
    'grocery_store.cart',
    'grocery_store.categories',
    'grocery_store.common',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'grocery_store_database',  # database name
...
AUTH_USER_MODEL = 'user_profile.GroceryStoreUser'
